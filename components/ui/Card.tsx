...
export interface CardHeaderProps {
  /** Card heading — named `heading` to avoid conflict with the DOM `title` attribute */
...
export function CardHeader({ heading, description, action, className }: CardHeaderProps) {
  return (
